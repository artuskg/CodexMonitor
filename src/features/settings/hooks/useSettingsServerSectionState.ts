...
type UseSettingsServerSectionStateParams = {
...
export const useSettingsServerSectionState = ({
  appSettings,
  onUpdateAppSettings,
  onMobileConnectSuccess,
  orbitServiceClient,
}: UseSettingsServerSectionStateParams) => {
  ...
  const updateRemoteBackendSettings = useCallback(
    async ({
      ...
      const nextToken = token === undefined ? latestSettings.remoteBackendToken : token;
